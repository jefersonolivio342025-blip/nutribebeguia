    ...
    <section className="py-16 md:py-20 px-4 bg-card">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 mb-10">
          {pains.map((pain, i) => (
            <AnimatedSection key={i} animation="up" delay={i * 100}>
              <div className="flex items-center gap-4 bg-background rounded-2xl p-5 border border-border shadow-sm">
          ...
          <div className="text-center bg-primary/5 rounded-2xl p-6 border border-primary/20">
            <p className="text-lg text-foreground font-semibold leading-relaxed">
              ...
              <span className="text-muted-foreground font-normal">
                E existe uma solução simples e acessível.
              </span>
            </p>
          </div>
        </AnimatedSection>
